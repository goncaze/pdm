...
class LivroCreateView(ft.View):
    ...
    def registrar(self, e):
        if self.validar():
            novo_livro = Livro(titulo=self.ttf_livro_titulo.value)
            self.livroDB.insert_livro(novo_livro)
